...
def Mod_SpecialArcs (G, s, t, budget, rev, Gamma1, restriction):
    ...
    x1 = model.addVars(G.edges, vtype=GRB.CONTINUOUS, name="x1", lb = 0, ub = GRB.INFINITY);
    theta1 = model.addVars(G.edges, vtype=GRB.CONTINUOUS, name="theta1", lb = 0, ub = 1); 
    alpha1 = model.addVars(G.nodes, vtype=GRB.CONTINUOUS, name="alpha1", lb = 0, ub = 1); 
    beta1 = model.addVars(G.edges, vtype=GRB.CONTINUOUS, name="beta1", lb = 0, ub = GRB.INFINITY);   
    ...
    model.addConstr(gp.quicksum(G.edges[i,j]['capacity']*beta1[i,j] for i,j in G.edges) <= rev);
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
